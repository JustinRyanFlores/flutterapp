            ...
            Expanded(
              child: ListView(
                children: [
                  ChatMessage(
                      isSent: true,
                      message: "I would like to file a ticket."),
                  ChatMessage(
                      isSent: false,
                      message:
                          "Hi, User_Sample_Name! How can I help you?"),
                  ChatMessage(
                      isSent: true,
                      message:
                          "Do the Chopsaw 2 4KW comes with a warranty?"),
                  ChatMessage(
                      isSent: false,
                      message: "Yes, they have a one-year warranty"),
                  ChatMessage(
                      isSent: false,
                      message:
                          "If you had anymore question feel free to approach us"),
                  ChatMessage(isSent: true, message: "Okay thanks!"),
